<template>
  <v-card tile :dark="dark" :color="getColor">
    <v-toolbar v-if="Boolean(type)" dense flat :dark="dark" :color="getColor">
    ...
    <v-card-text class="body-1 py-2" v-html="text" />
    <v-card-actions>
      <v-spacer />
