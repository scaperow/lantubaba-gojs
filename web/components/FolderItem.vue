<template>
  ...
  >
    ...
    <div class="text-truncate">{{ folder.name }}</div>
    <v-menu offset-y v-if="folder.isDelete !== true">
  ...
  <!-- <v-card-text v-else>
      <svg v-ripple @click.stop="$emit('open')" class="folder" xmlns="http://www.w3.org/2000/svg"
